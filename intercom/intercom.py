   ...
   #Constructor.
    ...
    def run(self):
        ...
        def receive_and_buffer():
            ...
            """recvfrom recibe datos en un socket nombrado por el socket descriptor y los almacena en un búfer. La función recvfrom () 
        ...
        def record_send_and_play(indata, outdata, frames, time, status):
            ...
            try:
                #Debido al método get_nowait, si la cola esta vacia no puede eliminar y devolver el elemento por lo que tenemos que controlar dicha excepción.
